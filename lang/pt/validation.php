...
return [
    ...
    | como as regras de tamanho. Sinta-se à vontade para ajustá-las aqui.
    |
    */
    ...
    */
    ...
    | atributo por algo mais amigável, como "Endereço de E-mail" em vez
    | de "email". Isso simplesmente ajuda a tornar nossa mensagem mais
    | expressiva.
    |
    */
